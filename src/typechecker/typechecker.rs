        ...
        match stmt {
            ...
            Stmt::If {
                ...
                for else_if_branch in else_if_branches {
                    let else_if_condition_type =
                        self.infer_expression_type(&else_if_branch.condition)?;
        ...
        match expr {
            ...
            Expr::BinaryOp { op, left, right } => {
                ...
                match op.kind {
                    ...
                    crate::token::TokenType::And | crate::token::TokenType::Or => {
                        Ok("bool".to_string())
                    }
